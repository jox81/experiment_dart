...
class GLTFCreation {
  ...
  GLTFBuffer _getBuffer(glTF.Buffer buffer) {
    ...
    return _gltfProject.buffers.firstWhere((b) => b.bufferId == id,
...
//        type : ShaderVariableType.getByComponentAndType(gltfSource.componentType,gltfSource.type),
  ...
  GLTFAccessor _getAccessor(glTF.Accessor accessor) {
    ...
    return _gltfProject.accessors.firstWhere((a) => a.accessorId == id,
        orElse: () => throw new Exception(
  ...
  GLTFSampler _getSampler(glTF.Sampler sampler) {
    ...
    return _gltfProject.samplers.firstWhere((s) => s.samplerId == id,
        orElse: () => throw new Exception(
  ...
  GLTFImage _getImage(glTF.Image image) {
    ...
    return _gltfProject.images.firstWhere((i) => i.sourceId == id,
        orElse: () => throw new Exception(
  ...
  GLTFPBRMaterial _getMaterial(glTF.Material material) {
    ...
    return _gltfProject.materials.firstWhere((m) => m.materialId == id,
        orElse: () => throw new Exception(
...
//      cameraPerspective.extras;
  ...
  Camera _getCamera(glTF.Camera gltfCamera) {
    ...
    return _gltfProject.cameras.firstWhere((c) => c.cameraId == id,
        orElse: () => throw new Exception(
  ...
  GLTFMesh _getMesh(glTF.Mesh mesh) {
    ...
    return _gltfProject.meshes.firstWhere((m) => m.meshId == id,
        orElse: () => throw new Exception(
  ...
  GLTFNode _getNode(glTF.Node node) {
    ...
    return _gltfProject.nodes.firstWhere((n) => n.nodeId == id,
        orElse: () => throw new Exception(
  ...
  GLTFScene _getScene(glTF.Scene scene) {
    ...
    return _gltfProject.scenes.firstWhere((s) => s.sceneId == id,
        orElse: () => throw new Exception(
