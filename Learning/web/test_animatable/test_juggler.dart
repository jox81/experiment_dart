...
class Form extends Sprite /*implements Animatable*/{
  ...
  void play(Trajectory trajectory, {num deltaTimeStep : 0.1}) {
    if(trajectory == null || trajectory.steps == 0) return;
    _deltaTimeStep = deltaTimeStep;
    _trajectory = trajectory;
    _goToIndex(_deltaTimeStep, 0);
  }
  ...
  _goToIndex(num deltaTime, int index) async {
    ...
    x = coord.x;
    y = coord.y;
    _goToIndex(deltaTime, ++index);
  }

  //Solution 02 pas de juggler
//  void play(Trajectory trajectory, {num deltaTimeStep : 0.1}) {
//    if(trajectory == null || trajectory.steps == 0) return;
//    _deltaTimeStep = deltaTimeStep;
//    _trajectory = trajectory;
//    coord = trajectory.coords[_currentStep];
//    x = coord.x;
//    y = coord.y;
//    _playNextStep();
//  }
...
//  void _playNextStep(){
//    _currentStep++;
//    if(_currentStep == _trajectory.steps ) return;
//
//    coord = _trajectory.coords[_currentStep];
//    x = coord.x;
//    y = coord.y;
//    stage.juggler.addTween(this, _deltaTimeStep)
//      ..animate.x.to(coord.x)
//      ..animate.y.to(coord.y)
//      ..onComplete = (){_playNextStep();};
//  }
