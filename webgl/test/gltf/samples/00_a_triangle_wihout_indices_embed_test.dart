...
Future main() async {
  ...
  setUp(() async {
    glTF.Gltf gltf = await GLTFProject.loadGLTFResource('/gltf/samples/gltf_2_0/00_triangle_without_indices/gltf_embed/TriangleWithoutIndices.gltf', useWebPath:true);
