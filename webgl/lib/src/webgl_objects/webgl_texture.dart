...
class TextureUtils {
  ...
  static WebGLTexture createColorTextureFromElement(ImageElement image,
    ...
    gl.activeTexture.setParameterInt(
        TextureTarget.TEXTURE_2D, TextureParameter.TEXTURE_WRAP_S, WRAP_S);
    gl.activeTexture.setParameterInt(
        TextureTarget.TEXTURE_2D, TextureParameter.TEXTURE_WRAP_T, WRAP_T);
    gl.activeTexture.setParameterInt(
...
//    gl.generateMipmap(RenderingContext.TEXTURE_2D);
  ...
  static WebGLTexture createColorTexture(int size) {
    ...
    gl.activeTexture.setParameterInt(TextureTarget.TEXTURE_2D,
...
//    gl.generateMipmap(RenderingContext.TEXTURE_2D);
  ...
  static WebGLTexture createColorCubeMapTexture(int size) {
    ...
    gl.activeTexture.setParameterInt(
        ...
        TextureParameter.TEXTURE_MAG_FILTER,
        TextureMagnificationFilterType.LINEAR);
    gl.activeTexture.setParameterInt(TextureTarget.TEXTURE_CUBE_MAP,
...
//    gl.generateMipmap(RenderingContext.TEXTURE_2D);
  ...
  static WebGLTexture createDepthTexture(int size) {
    ...
    gl.activeTexture.setParameterInt(
        ...
        TextureMinificationFilterType.NEAREST);
    gl.activeTexture.setParameterInt(
        target, TextureParameter.TEXTURE_WRAP_S, TextureWrapType.CLAMP_TO_EDGE);
    gl.activeTexture.setParameterInt(
        target, TextureParameter.TEXTURE_WRAP_T, TextureWrapType.CLAMP_TO_EDGE);
    gl.activeTexture.texImage2DWithWidthAndHeight(
        TextureAttachmentTarget.TEXTURE_2D,
        0,
...
//    var pixels = new Float32List(rectangle.width * rectangle.height * 4);
  ...
  static Future<List<ImageElement>> loadCubeMapImages(
    ...
    Map<String, List<String>> cubeMapsPath = {
      'test': [
        "/application/images/cubemap/test/test_px.png",
        "/application/images/cubemap/test/test_nx.png",
        "/application/images/cubemap/test/test_py.png",
        "/application/images/cubemap/test/test_ny.png",
        "/application/images/cubemap/test/test_pz.png",
        "/application/images/cubemap/test/test_nz.png",
      ],
      'kitchen': [
        "/application/images/cubemap/kitchen/c00.bmp",
        "/application/images/cubemap/kitchen/c01.bmp",
        "/application/images/cubemap/kitchen/c02.bmp",
        "/application/images/cubemap/kitchen/c03.bmp",
        "/application/images/cubemap/kitchen/c04.bmp",
        "/application/images/cubemap/kitchen/c05.bmp"
      ],
      'pisa': [
        "/application/images/cubemap/pisa/pisa_posx.jpg",
        "/application/images/cubemap/pisa/pisa_negx.jpg",
        "/application/images/cubemap/pisa/pisa_posy.jpg",
        "/application/images/cubemap/pisa/pisa_negy.jpg",
        "/application/images/cubemap/pisa/pisa_posz.jpg",
        "/application/images/cubemap/pisa/pisa_negz.jpg",
      ]
    };
    ...
    for(int i = 0; i < 6 ; i++) {
      imageElements[i] = await TextureUtils
          .getImageFromFile(paths[i]);
    }
  ...
  static WebGLTexture createCubeMapFromElements(
      List<ImageElement> cubeMapImages, {bool flip : true}) {
