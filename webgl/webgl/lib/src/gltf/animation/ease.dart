...
///
/// See also: [Ease], [Tween], [Transition]
///
/// Examples:
///
///     // a linear transition
...
/// The [Ease] class provides common transition functions used by
...
abstract class Ease {
  ...
  static num barycenter(num a, num b, num t) {
    return a + ((b - a) * t);
  }

  static num sine10(num ratio) {
    return 0.5 - 0.5 * cos(ratio * 10.0 * pi);
  }
