...
class UtilsGeometry{
  ...
  static List<PointModel> unProjectMultiScreenPoints(GLTFCameraPerspective camera) {
  ...
  static Model findModelFromMouseCoords(GLTFCameraPerspective camera, num x, num y, List<Model> models) {
